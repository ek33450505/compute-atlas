      ...
      {links.map(({ label, href }) => {
        ...
        return (
          <Link
            ...
            className={cn(
              "relative flex h-11 items-center px-1.5 sm:px-3 font-mono text-xs uppercase tracking-normal sm:tracking-wider text-muted-foreground transition-colors hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 rounded-sm",
